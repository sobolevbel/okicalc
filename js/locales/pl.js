export default {
  ...
  'verdict.tie': 'Remis — oba kończą z tą samą kwotą',
  'verdict.detail': '{oki} na OKI wobec {reg} na zwykłym koncie ({pct})',
  'verdict.beUntil': 'OKI pozostaje na plusie przez pierwsze {years}; potem roczna opłata przerasta korzyść z odroczenia podatku.',
  ...
  'chart.taxes.subtitle': 'Wszystko, co każdą drogą trafia do fiskusa',
  ...
  'table.subtitle': 'Każda komórka pokazuje ostatni rok, w którym OKI jeszcze wygrywa dla danej kwoty i stopy zwrotu. 0 = przegrywa od pierwszego roku, 50+ = wygrywa ponad 50 lat. Kliknij komórkę, aby załadować ją jako swój scenariusz.',
  ...
  'formulas.okiStepNote': 'Wpłata trafia na początek roku, portfel rośnie o oczekiwany zwrot, na końcu pobierana jest opłata.',
