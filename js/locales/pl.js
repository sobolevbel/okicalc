export default {
  ...
  'controls.limitUsed': 'Limit już wykorzystany przez wcześniejsze inwestycje',
  'controls.limitUsedHint': 'Załóż, że na OKI leżą już aktywa o wartości całego limitu. Nowe wpłaty nie korzystają wtedy ze zwolnienia — opłata OKI jest naliczana od pierwszej złotówki, a kalkulator porównuje wyłącznie los nowych pieniędzy.',
  ...
  'explain.limitUsed': 'Zgodnie z ustawieniami limit zwolnienia jest już w całości wykorzystany przez wcześniejsze aktywa na OKI, więc opłata OKI obejmuje modelowane pieniądze od pierwszej złotówki, a strategia mieszana traci sens.',
  ...
  'privacy.note': 'Wszystko, co wpisujesz, zostaje w Twojej przeglądarce — obliczenia wykonują się lokalnie i nigdzie nie są wysyłane. Na Twoim urządzeniu zapisywany jest tylko wybór języka i motywu. Strona zbiera anonimowe statystyki odwiedzin i korzystania (GoatCounter) — bez plików cookie i bez identyfikatorów.',
